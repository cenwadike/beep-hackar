...
import (
	...
	intentmodule "beep/x/intent/module"
...
func (app *App) registerIBCModules(appOpts servertypes.AppOptions) error {
	...
	intentIBCModule := ibcfee.NewIBCMiddleware(intentmodule.NewIBCModule(app.IntentKeeper), app.IBCFeeKeeper)
	ibcRouter.AddRoute(intentmoduletypes.ModuleName, intentIBCModule)
