...
func (im IBCModule) OnRecvPacket(
	...
	var modulePacketData types.IntentPacketData
	...
	case *types.IntentPacketData_IntentPacketPacket:
		packetAck, err := im.keeper.OnRecvIntentPacketPacket(ctx, modulePacket, *packet.IntentPacketPacket)
		if err != nil {
		...
		ctx.EventManager().EmitEvent(
			sdk.NewEvent(
				types.EventTypeIntentPacketPacket,
...
func (im IBCModule) OnAcknowledgementPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.IntentPacketData_IntentPacketPacket:
		err := im.keeper.OnAcknowledgementIntentPacketPacket(ctx, modulePacket, *packet.IntentPacketPacket, ack)
		if err != nil {
			return err
		}
		eventType = types.EventTypeIntentPacketPacket
...
func (im IBCModule) OnTimeoutPacket(
	...
	switch packet := modulePacketData.Packet.(type) {
	case *types.IntentPacketData_IntentPacketPacket:
		err := im.keeper.OnTimeoutIntentPacketPacket(ctx, modulePacket, *packet.IntentPacketPacket)
		if err != nil {
			return err
		}
