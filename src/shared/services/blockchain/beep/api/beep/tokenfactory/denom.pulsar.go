...
func init() {
	...
	md_Denom = File_beep_tokenfactory_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_beep_tokenfactory_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "beep.tokenfactory.Denom.denom":
		return x.Denom != ""
	case "beep.tokenfactory.Denom.description":
		return x.Description != ""
	case "beep.tokenfactory.Denom.ticker":
		return x.Ticker != ""
	case "beep.tokenfactory.Denom.precision":
		return x.Precision != int32(0)
	case "beep.tokenfactory.Denom.url":
		return x.Url != ""
	case "beep.tokenfactory.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "beep.tokenfactory.Denom.supply":
		return x.Supply != int32(0)
	case "beep.tokenfactory.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "beep.tokenfactory.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: beep.tokenfactory.Denom"))
		}
		panic(fmt.Errorf("message beep.tokenfactory.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message beep.tokenfactory.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "beep.tokenfactory.Denom.denom":
		panic(fmt.Errorf("field denom of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.description":
		panic(fmt.Errorf("field description of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.ticker":
		panic(fmt.Errorf("field ticker of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.precision":
		panic(fmt.Errorf("field precision of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.url":
		panic(fmt.Errorf("field url of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.supply":
		panic(fmt.Errorf("field supply of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message beep.tokenfactory.Denom is not mutable"))
	case "beep.tokenfactory.Denom.owner":
		panic(fmt.Errorf("field owner of message beep.tokenfactory.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: beep.tokenfactory.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in beep.tokenfactory.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: beep/tokenfactory/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_beep_tokenfactory_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_beep_tokenfactory_denom_proto protoreflect.FileDescriptor

var file_beep_tokenfactory_denom_proto_rawDesc = []byte{
...
var (
	file_beep_tokenfactory_denom_proto_rawDescOnce sync.Once
	file_beep_tokenfactory_denom_proto_rawDescData = file_beep_tokenfactory_denom_proto_rawDesc
)

func file_beep_tokenfactory_denom_proto_rawDescGZIP() []byte {
	file_beep_tokenfactory_denom_proto_rawDescOnce.Do(func() {
		file_beep_tokenfactory_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_beep_tokenfactory_denom_proto_rawDescData)
	})
	return file_beep_tokenfactory_denom_proto_rawDescData
}

var file_beep_tokenfactory_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_beep_tokenfactory_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: beep.tokenfactory.Denom
}
var file_beep_tokenfactory_denom_proto_depIdxs = []int32{
...
func init() { file_beep_tokenfactory_denom_proto_init() }
func file_beep_tokenfactory_denom_proto_init() {
	if File_beep_tokenfactory_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_beep_tokenfactory_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_beep_tokenfactory_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_beep_tokenfactory_denom_proto_goTypes,
		DependencyIndexes: file_beep_tokenfactory_denom_proto_depIdxs,
		MessageInfos:      file_beep_tokenfactory_denom_proto_msgTypes,
	}.Build()
	File_beep_tokenfactory_denom_proto = out.File
	file_beep_tokenfactory_denom_proto_rawDesc = nil
	file_beep_tokenfactory_denom_proto_goTypes = nil
	file_beep_tokenfactory_denom_proto_depIdxs = nil
}
