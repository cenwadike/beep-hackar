...
const (
	Query_Params_FullMethodName   = "/beep.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/beep.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/beep.tokenfactory.Query/DenomAll"
)
