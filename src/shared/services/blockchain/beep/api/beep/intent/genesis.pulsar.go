...
func init() {
	file_beep_intent_genesis_proto_init()
...
func (x *GenesisState) slowProtoReflect() protoreflect.Message {
	mi := &file_beep_intent_genesis_proto_msgTypes[0]
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "beep.intent.GenesisState.params":
		return x.Params != nil
	...
	default:
		...
		panic(fmt.Errorf("message beep.intent.GenesisState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message beep.intent.GenesisState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_GenesisState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in beep.intent.GenesisState", d.FullName()))
	}
	panic("unreachable")
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return file_beep_intent_genesis_proto_rawDescGZIP(), []int{0}
}
...
var file_beep_intent_genesis_proto_rawDesc = []byte{
	0x0a, 0x19, 0x62, 0x65, 0x65, 0x70, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x2f, 0x67, 0x65,
	0x6e, 0x65, 0x73, 0x69, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x62, 0x65, 0x65,
	0x70, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x1a, 0x11, 0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2f,
...
var (
	file_beep_intent_genesis_proto_rawDescOnce sync.Once
	file_beep_intent_genesis_proto_rawDescData = file_beep_intent_genesis_proto_rawDesc
)

func file_beep_intent_genesis_proto_rawDescGZIP() []byte {
	file_beep_intent_genesis_proto_rawDescOnce.Do(func() {
		file_beep_intent_genesis_proto_rawDescData = protoimpl.X.CompressGZIP(file_beep_intent_genesis_proto_rawDescData)
	})
	return file_beep_intent_genesis_proto_rawDescData
}

var file_beep_intent_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
...
func file_beep_intent_genesis_proto_init() {
	if File_beep_intent_genesis_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_beep_intent_genesis_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_beep_intent_genesis_proto_goTypes,
		DependencyIndexes: file_beep_intent_genesis_proto_depIdxs,
		MessageInfos:      file_beep_intent_genesis_proto_msgTypes,
	}.Build()
	File_beep_intent_genesis_proto = out.File
	file_beep_intent_genesis_proto_rawDesc = nil
	file_beep_intent_genesis_proto_goTypes = nil
	file_beep_intent_genesis_proto_depIdxs = nil
}
